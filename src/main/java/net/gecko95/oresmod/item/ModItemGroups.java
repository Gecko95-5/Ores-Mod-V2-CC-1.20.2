    ...
    public static final ItemGroup ORES_MOD_ORES_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().displayName(Text.translatable("itemgroup.ores_mod_ores"))
                    .icon(() -> new ItemStack(ModBlocks.ALUMINUM_ORE)).entries((displayContext, entries) -> {
                        ...
                        entries.add(ModBlocks.STONE_MASONRY_BRICK_WALL);
                        entries.add(ModBlocks.NETHER_MASONRY_BRICKS);
                        entries.add(ModBlocks.NETHER_MASONRY_BRICK_STAIRS);
                        entries.add(ModBlocks.NETHER_MASONRY_BRICK_SLAB);
                        entries.add(ModBlocks.NETHER_MASONRY_BRICK_WALL);
                        entries.add(ModBlocks.NETHER_UNIFORM_BRICKS);
                        entries.add(ModBlocks.NETHER_UNIFORM_BRICK_STAIRS);
                        entries.add(ModBlocks.NETHER_UNIFORM_BRICK_SLAB);
                        entries.add(ModBlocks.NETHER_UNIFORM_BRICK_WALL);
                        entries.add(ModBlocks.PRISMARINE_MASONRY_BRICKS);
                        entries.add(ModBlocks.PRISMARINE_MASONRY_BRICK_STAIRS);
                        entries.add(ModBlocks.PRISMARINE_MASONRY_BRICK_SLAB);
                        entries.add(ModBlocks.PRISMARINE_MASONRY_BRICK_WALL);
                        entries.add(ModBlocks.PRISMARINE_UNIFORM_BRICKS);
                        entries.add(ModBlocks.PRISMARINE_UNIFORM_BRICK_STAIRS);
                        entries.add(ModBlocks.PRISMARINE_UNIFORM_BRICK_SLAB);
                        entries.add(ModBlocks.PRISMARINE_UNIFORM_BRICK_WALL);
                        entries.add(ModBlocks.END_STONE_MASONRY_BRICKS);
                        entries.add(ModBlocks.END_STONE_MASONRY_BRICK_STAIRS);
                        entries.add(ModBlocks.END_STONE_MASONRY_BRICK_SLAB);
                        entries.add(ModBlocks.END_STONE_MASONRY_BRICK_WALL);
                        entries.add(ModBlocks.END_STONE_UNIFORM_BRICKS);
                        entries.add(ModBlocks.END_STONE_UNIFORM_BRICK_STAIRS);
                        entries.add(ModBlocks.END_STONE_UNIFORM_BRICK_SLAB);
                        entries.add(ModBlocks.END_STONE_UNIFORM_BRICK_WALL);
                        entries.add(ModBlocks.RED_NETHER_MASONRY_BRICKS);
                        entries.add(ModBlocks.RED_NETHER_MASONRY_BRICK_STAIRS);
                        entries.add(ModBlocks.RED_NETHER_MASONRY_BRICK_SLAB);
                        entries.add(ModBlocks.RED_NETHER_MASONRY_BRICK_WALL);
                        entries.add(ModBlocks.RED_NETHER_UNIFORM_BRICKS);
                        entries.add(ModBlocks.RED_NETHER_UNIFORM_BRICK_STAIRS);
                        entries.add(ModBlocks.RED_NETHER_UNIFORM_BRICK_SLAB);
                        entries.add(ModBlocks.RED_NETHER_UNIFORM_BRICK_WALL);
                        entries.add(ModBlocks.POLISHED_BLACKSTONE_MASONRY_BRICKS);
                        entries.add(ModBlocks.POLISHED_BLACKSTONE_MASONRY_BRICK_STAIRS);
                        entries.add(ModBlocks.POLISHED_BLACKSTONE_MASONRY_BRICK_SLAB);
                        entries.add(ModBlocks.POLISHED_BLACKSTONE_MASONRY_BRICK_WALL);
                        entries.add(ModBlocks.QUARTZ_MASONRY_BRICKS);
                        entries.add(ModBlocks.QUARTZ_MASONRY_BRICK_STAIRS);
                        entries.add(ModBlocks.QUARTZ_MASONRY_BRICK_SLAB);
                        entries.add(ModBlocks.QUARTZ_MASONRY_BRICK_WALL);
                        entries.add(ModBlocks.QUARTZ_UNIFORM_BRICKS);
                        entries.add(ModBlocks.QUARTZ_UNIFORM_BRICK_STAIRS);
                        entries.add(ModBlocks.QUARTZ_UNIFORM_BRICK_SLAB);
                        entries.add(ModBlocks.QUARTZ_UNIFORM_BRICK_WALL);
                        entries.add(ModBlocks.DEEPSLATE_MASONRY_BRICKS);
                        entries.add(ModBlocks.DEEPSLATE_MASONRY_BRICK_STAIRS);
                        entries.add(ModBlocks.DEEPSLATE_MASONRY_BRICK_SLAB);
                        entries.add(ModBlocks.DEEPSLATE_MASONRY_BRICK_WALL);
                        entries.add(ModBlocks.MUD_MASONRY_BRICKS);
                        entries.add(ModBlocks.MUD_MASONRY_BRICK_STAIRS);
                        entries.add(ModBlocks.MUD_MASONRY_BRICK_SLAB);
                        entries.add(ModBlocks.MUD_MASONRY_BRICK_WALL);
                        entries.add(ModBlocks.MUD_UNIFORM_BRICKS);
                        entries.add(ModBlocks.MUD_UNIFORM_BRICK_STAIRS);
                        entries.add(ModBlocks.MUD_UNIFORM_BRICK_SLAB);
                        entries.add(ModBlocks.MUD_UNIFORM_BRICK_WALL);
                        entries.add(ModBlocks.MARBLE_MASONRY_BRICKS);
                        entries.add(ModBlocks.MARBLE_MASONRY_BRICK_STAIRS);
                        entries.add(ModBlocks.MARBLE_MASONRY_BRICK_SLAB);
                        entries.add(ModBlocks.MARBLE_MASONRY_BRICK_WALL);
                        entries.add(ModBlocks.POLISHED_ANDESITE_MASONRY_BRICKS);
                        entries.add(ModBlocks.POLISHED_ANDESITE_MASONRY_BRICK_STAIRS);
                        entries.add(ModBlocks.POLISHED_ANDESITE_MASONRY_BRICK_SLAB);
                        entries.add(ModBlocks.POLISHED_ANDESITE_MASONRY_BRICK_WALL);
                        entries.add(ModBlocks.POLISHED_DIORITE_MASONRY_BRICKS);
                        entries.add(ModBlocks.POLISHED_DIORITE_MASONRY_BRICK_STAIRS);
                        entries.add(ModBlocks.POLISHED_DIORITE_MASONRY_BRICK_SLAB);
                        entries.add(ModBlocks.POLISHED_DIORITE_MASONRY_BRICK_WALL);
                        entries.add(ModBlocks.POLISHED_GRANITE_MASONRY_BRICKS);
                        entries.add(ModBlocks.POLISHED_GRANITE_MASONRY_BRICK_STAIRS);
                        entries.add(ModBlocks.POLISHED_GRANITE_MASONRY_BRICK_SLAB);
                        entries.add(ModBlocks.POLISHED_GRANITE_MASONRY_BRICK_WALL);
                        entries.add(ModBlocks.POLISHED_BEDROCK_MASONRY_BRICKS);
                        entries.add(ModBlocks.POLISHED_BEDROCK_MASONRY_BRICK_STAIRS);
                        entries.add(ModBlocks.POLISHED_BEDROCK_MASONRY_BRICK_SLAB);
                        entries.add(ModBlocks.POLISHED_BEDROCK_MASONRY_BRICK_WALL);
                        entries.add(ModBlocks.VOID_STONE_MASONRY_BRICKS);
                        entries.add(ModBlocks.VOID_STONE_MASONRY_BRICK_STAIRS);
                        entries.add(ModBlocks.VOID_STONE_MASONRY_BRICK_SLAB);
                        entries.add(ModBlocks.VOID_STONE_MASONRY_BRICK_WALL);
                        entries.add(ModBlocks.VOID_STONE_UNIFORM_BRICKS);
                        entries.add(ModBlocks.VOID_STONE_UNIFORM_BRICK_STAIRS);
                        entries.add(ModBlocks.VOID_STONE_UNIFORM_BRICK_SLAB);
                        entries.add(ModBlocks.VOID_STONE_UNIFORM_BRICK_WALL);
                        ...
                        entries.add(ModBlocks.CUT_FROSITE);
                        entries.add(ModBlocks.CUT_FROSITE_STAIRS);
                        entries.add(ModBlocks.CUT_FROSITE_SLAB);
                        entries.add(ModBlocks.CUT_FROSITE_WALL);
                        ...
                        entries.add(ModBlocks.LIGHT_CUT_FROSITE);
                        entries.add(ModBlocks.LIGHT_CUT_FROSITE_STAIRS);
                        entries.add(ModBlocks.LIGHT_CUT_FROSITE_SLAB);
                        entries.add(ModBlocks.LIGHT_CUT_FROSITE_WALL);
                        ...
                        entries.add(ModBlocks.DARK_FROSITE_BLOCK);
                        entries.add(ModBlocks.DARK_FROSITE_BRICKS);
                        entries.add(ModBlocks.DARK_FROSITE_BRICK_STAIRS);
                        entries.add(ModBlocks.DARK_FROSITE_BRICK_SLAB);
                        entries.add(ModBlocks.DARK_FROSITE_BRICK_WALL);
                        entries.add(ModBlocks.DARK_CUT_FROSITE);
                        entries.add(ModBlocks.DARK_CUT_FROSITE_STAIRS);
                        entries.add(ModBlocks.DARK_CUT_FROSITE_SLAB);
                        entries.add(ModBlocks.DARK_CUT_FROSITE_WALL);
                        entries.add(ModBlocks.DARK_FROSITE_BUTTON);
                        entries.add(ModBlocks.DARK_FROSITE_PRESSURE_PLATE);
                        entries.add(ModBlocks.DARK_REINFORCED_FROSITE_BLOCK);
                        ...
                        entries.add(ModBlocks.CUT_SANDITE);
                        entries.add(ModBlocks.CUT_SANDITE_STAIRS);
                        entries.add(ModBlocks.CUT_SANDITE_SLAB);
                        entries.add(ModBlocks.CUT_SANDITE_WALL);
                        ...
                        entries.add(ModBlocks.LIGHT_CUT_SANDITE);
                        entries.add(ModBlocks.LIGHT_CUT_SANDITE_STAIRS);
                        entries.add(ModBlocks.LIGHT_CUT_SANDITE_SLAB);
                        entries.add(ModBlocks.LIGHT_CUT_SANDITE_WALL);
                        entries.add(ModBlocks.DARK_SANDITE_BLOCK);
                        entries.add(ModBlocks.DARK_SANDITE_BRICKS);
                        entries.add(ModBlocks.DARK_SANDITE_BRICK_STAIRS);
                        entries.add(ModBlocks.DARK_SANDITE_BRICK_SLAB);
                        entries.add(ModBlocks.DARK_SANDITE_BRICK_WALL);
                        entries.add(ModBlocks.DARK_CUT_SANDITE);
                        entries.add(ModBlocks.DARK_CUT_SANDITE_STAIRS);
                        entries.add(ModBlocks.DARK_CUT_SANDITE_SLAB);
                        entries.add(ModBlocks.DARK_CUT_SANDITE_WALL);
                        ...
                        entries.add(ModBlocks.CUT_LEAFITE);
                        entries.add(ModBlocks.CUT_LEAFITE_STAIRS);
                        entries.add(ModBlocks.CUT_LEAFITE_SLAB);
                        entries.add(ModBlocks.CUT_LEAFITE_WALL);
                        ...
                        entries.add(ModBlocks.LIGHT_CUT_LEAFITE);
                        entries.add(ModBlocks.LIGHT_CUT_LEAFITE_STAIRS);
                        entries.add(ModBlocks.LIGHT_CUT_LEAFITE_SLAB);
                        entries.add(ModBlocks.LIGHT_CUT_LEAFITE_WALL);
                        entries.add(ModBlocks.DARK_LEAFITE_BLOCK);
                        entries.add(ModBlocks.DARK_LEAFITE_BRICKS);
                        entries.add(ModBlocks.DARK_LEAFITE_BRICK_STAIRS);
                        entries.add(ModBlocks.DARK_LEAFITE_BRICK_SLAB);
                        entries.add(ModBlocks.DARK_LEAFITE_BRICK_WALL);
                        entries.add(ModBlocks.DARK_CUT_LEAFITE);
                        entries.add(ModBlocks.DARK_CUT_LEAFITE_STAIRS);
                        entries.add(ModBlocks.DARK_CUT_LEAFITE_SLAB);
                        entries.add(ModBlocks.DARK_CUT_LEAFITE_WALL);
                        ...
                        entries.add(ModBlocks.CUT_END_ITE);
                        entries.add(ModBlocks.CUT_END_ITE_STAIRS);
                        entries.add(ModBlocks.CUT_END_ITE_SLAB);
                        entries.add(ModBlocks.CUT_END_ITE_WALL);
                        ...
                        entries.add(ModBlocks.LIGHT_CUT_END_ITE);
                        entries.add(ModBlocks.LIGHT_CUT_END_ITE_STAIRS);
                        entries.add(ModBlocks.LIGHT_CUT_END_ITE_SLAB);
                        ...
                        entries.add(ModBlocks.DARK_CUT_END_ITE_WALL);
